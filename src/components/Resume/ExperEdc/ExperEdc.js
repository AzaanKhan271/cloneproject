        ...
        <div className='column' style={{backgroundColor:'transparent',border:'none'}}>
          ...
          >
            <div className='heading' style={{marginLeft:'-5%'}}>
              <h2 >Experience</h2>
              <div  id="left_line"></div>
              <div style={{left:'10%'}} id="right_line"></div>
            ...
            >
             <div
             style={{display:'flex',marginLeft:"12%",alignItems:'center',paddingTop:'2%'}}
             ><h5 className='edcSubHead'>2013 - 2016</h5><span style={{marginLeft:'2%'}}>Locost Accessories</span></div> 
             <div style={{paddingLeft:'5%',paddingTop:'2%'}}>
               <h4 style={{fontSize:'16px'}}>Senior UI/UX Designer</h4>
               <p style={{fontSize:'.92em'}}>Duis posuere, quam non imperdiet egestas, eros enim mattis mauris, in posuere lacus arcu quis felis. Etiam interdum erat non enim venenatis fermentum</p>
             </div>
            </div>
            <div 
            ...
            >
             <div
             style={{display:'flex',marginLeft:"12%",alignItems:'center',paddingTop:'2%'}}
             ><h5 className='edcSubHead'>2011 - 2013</h5><span style={{marginLeft:'2%'}}>Sagebrush</span></div> 
             <div style={{paddingLeft:'5%',paddingTop:'2%'}}>
               <h4 style={{fontSize:'16px'}}>Junior UI/UX Designer</h4>
               <p style={{fontSize:'.92em'}}>Duis posuere, quam non imperdiet egestas, eros enim mattis mauris, in posuere lacus arcu quis felis. Etiam interdum erat non enim venenatis fermentum</p>
             </div>
            </div>
            <div 
            ...
            >
             <div
             style={{display:'flex',marginLeft:"12%",alignItems:'center',paddingTop:'2%'}}
             ><h5 className='edcSubHead'>2009 - 2011</h5><span style={{marginLeft:'2%'}}>Tilism Technologies</span></div> 
             <div style={{paddingLeft:'5%',paddingTop:'2%'}}>
               <h4 style={{fontSize:'16px'}}>Software Engineer</h4>
               <p style={{fontSize:'.92em'}}>Duis posuere, quam non imperdiet egestas, eros enim mattis mauris, in posuere lacus arcu quis felis. Etiam interdum erat non enim venenatis fermentum</p>
             </div>
            </div>
